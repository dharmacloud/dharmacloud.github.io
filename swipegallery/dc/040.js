jsonp(40,{"name":"dc","start":107582},`又云。修行般若波羅蜜多時。不著預流果。不著一來果不還果。阿羅漢果。抑又見四羅漢得是果。而不存所得心也。今我佛恐四羅漢。不知以無念為宗。尚萌所得之念。故設四問。以為能作得果得道之念不。須菩提皆以不也答之。復為之辨論。以形容其所得之實。夫入流者。初入其門。得預聖人之流也。須陀洹已證入流之果。名為入流。且心無所得。故曰而無所入。其所以無所入者。不入六塵境界耳。名須陀洹。其以是歟。
